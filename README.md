...
| 🔜  **[Pedernales Falls](https://en.wikipedia.org/wiki/Pedernales_Falls_State_Park)**<br>*Blanco County* | <img src="https://texashillcountry.com/wp-content/uploads/Pedernales-Falls-State-Park.jpg" width="250"> | 🗓 `Okay to visit year-round`<br>🦌: `Deer, coyotes, rabbits, armadillos`<br>🥾: `Twin Falls Hike, .5 mi`<br>⛰: `Limestone`<br>🐶: `Must be leashed`| 
